...
var debug = require('debug')('mongodb-compass:stores:mworld');

var gdataService = void 0;
 ...
 * Mworld store.
 */
var MworldStore = Reflux.createStore({
  /**
  ...
  handleQueryStoreChange: function handleQueryStoreChange(state) {
    debug(arguments);
    debug(state);
    debug(this.state);
